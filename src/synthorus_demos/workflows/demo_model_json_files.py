...
from synthorus.workflows.file_names import MODEL_SPEC_FILE_NAME, MODEL_INDEX_FILE_NAME, MODEL_META_FILE_NAME
...
def main() -> None:
    ...
    with output_directory(DEMO_NAME, overwrite=True) as model_definition_dir:
        ...
        show_file(model_definition_dir / MODEL_META_FILE_NAME)
