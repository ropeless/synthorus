# Default name to use for an entity 'id' field.
DEFAULT_ID_FIELD = '_id_'
...
# Default entity cardinality when none provided.
DEFAULT_FIXED_CARDINALITY = 1

# Default for whether to print warnings on loading a spec file.
DEFAULT_PRINT_WARNINGS = False

# Default for max_add_rows.
