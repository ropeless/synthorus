...
class DatasetCacheTest(Fixture):
    ...
    def test_simple(self) -> None:
        ...
        model_spec.entities['entity_x'] = ModelEntitySpec(
            ...
            foreign_key_fields=[ForeignKeyField(foreign_entity='entity_a', foreign_key_field_name='foreign_a')],
        )
        ...
        self.assertEmpty(model_index.entities['entity_a'].ancestors)
        self.assertEqual(model_index.entities['entity_a'].sample_rvs(), {'A'})
        ...
        self.assertEqual(model_index.entities['entity_x'].ancestors, ['entity_a'])
        self.assertEqual(model_index.entities['entity_x'].sample_rvs(), {'X'})
    ...
    def test_ancestor_conditions(self) -> None:
        ...
        self.assertEqual(model_index.entities['entity_a'].ancestors, [])
        self.assertEqual(model_index.entities['entity_a'].sample_rvs(), {'A'})
        self.assertEqual(len(model_index.entities['entity_a'].entity_crosstabs), 1)
